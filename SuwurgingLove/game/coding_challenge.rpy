init python:
    ...
    class SequentialChallengeBuffer:
        def __init__(self):
            ...
            self.languages = ["python", "cpp", "javascript", "java", "rust"]
            self.topics = [
                "sorting algorithms", "memory management", "data structures",
                "string manipulation", "error handling", "recursion",
                "array operations", "file handling", "networking", "concurrency"
            ]
            self.start_worker()
...
label start_challenge_sequence:
    ...
    sp "Bzzt! Multiple languages with proper coloring! ⚡"
